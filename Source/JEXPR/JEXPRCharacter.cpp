...
void AJEXPRCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void AJEXPRCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void AJEXPRCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AJEXPRCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
